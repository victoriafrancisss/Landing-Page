            ...
            {LOGOS.map((logo) => (
              ...
              >
                <img
                  src={logo.src}
                  alt=""
                  className="h-[40px] w-auto max-w-[120px] object-contain object-center grayscale opacity-50 transition-all duration-300 group-hover:grayscale-0 group-hover:opacity-100"
